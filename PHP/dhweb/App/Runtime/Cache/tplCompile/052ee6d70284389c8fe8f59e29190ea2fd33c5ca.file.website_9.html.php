<?php /* Smarty version Smarty-3.0.7, created on 2012-03-16 09:47:25
         compiled from "./App/Tpl/duohuo/Home/website_9.html" */ ?>
<?php /*%%SmartyHeaderCode:198724f629bad569487-24300180%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '052ee6d70284389c8fe8f59e29190ea2fd33c5ca' => 
    array (
      0 => './App/Tpl/duohuo/Home/website_9.html',
      1 => 1331285104,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '198724f629bad569487-24300180',
  'function' => 
  array (
  ),
...
?>
				...
				<li <?php if ($_smarty_tpl->getVariable('catbro')->value[$_smarty_tpl->getVariable('smarty')->value['section']['lmdh']['index']]['id']==$_smarty_tpl->getVariable('thisapp')->value['id']){?>class="on"<?php }?>><span><a href="<?php echo $_smarty_tpl->getVariable('syscfg')->value['i'];?>
...
App/Tpl/duohuo/Home/images/banner2.jpg" width="722" height="238" alt="banner" /></div>
...
App/Tpl/duohuo/Home/images/fangan_content1.png">
					...
					<div class="fangan_content_middle_right">
						...
						<p class="fangan_content_middle_title">专业设计</p>

						<p class="fangan_content_middle_content">为提高界面的用户体验性，设计师上门一对一咨询服务，功能强大，让您的网站夺人眼球！</p>
...
App/Tpl/duohuo/Home/images/dinggou.jpg" border="0"></a><span>购买前有疑问？ <a href="http://sighttp.qq.com/msgrd?v=1&uin=385819220&site=多火网络&menu=yes">在线咨询</a> 或致电 025-58053100 / 15195819107</span>
    ...
    <div class="liucheng">
		<span class="liucheng_title">标准网站建设服务流程</span><span class="liucheng_right">20天基本完成网站</span>
	</div>
	<div class="question">
		<div class="question_top">
			<ul>
				<li class="question_top_on"><a href="##">行业需求</a></li>
				<li><a href="##">设计案例</a></li>
				<li><a href="##">为什么选择</a></li>
				<li><a href="##">常见问题</a></li>
			</ul>
		</div>
		<div class="question_midlle question_midlle1" style="display:none;">
			<dl>
				...
				<dd>
					<img src="<?php echo $_smarty_tpl->getVariable('syscfg')->value['root'];?>
App/Tpl/duohuo/Home/images/try.jpg" width="170px" height="120px">
					<div class="question_midlle_right">
						<p class="question_midlle_title">企业门户展示网站</p>
						<p>文章（新闻）发布系统，公司行业资讯发布</p>
						<p>简易产品管理发布系统，产品分类，产品详情。</p>
						<p>客户留言反馈系统</p>
						<P>网站流量统计</P>
					</div>
...
App/Tpl/duohuo/Home/images/try.jpg" width="170px" height="120px">
					<div class="question_midlle_right">
						<p class="question_midlle_title">教育院校门户网站</p>
						<p>文章（新闻）发布系统，公告资讯发布</p>
						<p>图片，媒体发布宣传，院校风采展示</p>
						<p>用户留言反馈系统</p>
						<P>信息智能搜索系统</P>
					</div>
					<div class="clear"></div>
...
App/Tpl/duohuo/Home/images/try.jpg" width="170px" height="120px">
					<div class="question_midlle_right">
						<p class="question_midlle_title">政府事业单位门户网站</p>
						<p>文章（新闻）发布系统，公告资讯发布</p>
						<p>电子政务公开，网上通报系统</p>
						<p>用户留言反馈系统</p>
						<P>信息智能搜索系统</P>
...
App/Tpl/duohuo/Home/images/case_img.png" width="155" height="200"></a></li>
				<li><a href="#"><img src="<?php echo $_smarty_tpl->getVariable('syscfg')->value['root'];?>
App/Tpl/duohuo/Home/images/case_img.png" width="155" height="200"></a></li>
				<li><a href="#"><img src="<?php echo $_smarty_tpl->getVariable('syscfg')->value['root'];?>
App/Tpl/duohuo/Home/images/case_img.png" width="155" height="200"></a></li>
...
App/Tpl/duohuo/Home/images/answer_span.jpg">
					<div class="question_question_right">
						<p class="question_title">多火拥有三大资源</p>
						<p class="question_answer">
						•高校资源：首批入驻江苏省创业园精品企业 / 国家重点院校合作单位 / 权威教授导师技术支持顾问/本科生研究生实训基地<br>
•市场资源：多年IT互联网行业经验 / B2B SNS主流电子商务模式研究 / 精准的市场定位和发展趋势判断 / 多家大型IT公司密切合作<br>
...
App/Tpl/duohuo/Home/images/answer_span.jpg">
					<div class="question_question_right">
						<p class="question_title">多火具备五大优势</p>
						<p class="question_answer">
						•技术优势：多火最核心的是一支雄厚的技术团队力量。<br>
•品牌优势：作为最具创造力的IT企业，多火已经成为越来越多企业的首选！<br>
•稳定优势：服务器硬件+软件程序+完善后期服务 = 全方位的稳定保障！<br>
•服务优势：7x24小时的客户服务，第一时间响应受理，做最可靠的网络管家！<br>
...
App/Tpl/duohuo/Home/images/answer_span.jpg">
					<div class="question_question_right">
						<p class="question_title">首家CESV立体式互联网服务商</p>
						<p class="question_answer">
						Customization ：深度行业发掘，虚拟网络+现实市场 综合方案需求；<br>
						Expansibility：产品可升级扩展，一站式专业技术支持，为后期发展节约时间和成本；<br>
Service：终身管家服务，不再重销售，轻售后；<br>
...
App/Tpl/duohuo/Home/images/answer_span.jpg">
					<div class="question_question_right">
						<p class="question_title">网站做好之后你们负责网站后期维护吗？</p>
						<p class="question_answer">多火不仅重视产品，更注重后期的服务。我们为每个客户都提供完善的后期技术支持和系统维护，让您没有后顾之忧！</p>
					</div>
					<div class="clear"></div>
				</li>
				<li>
...
App/Tpl/duohuo/Home/images/answer_span.jpg">
					<div class="question_question_right">
						<p class="question_title">网站后期维护包含哪些？需不需要另外支付费用？</p>
						<p class="question_answer">我们后期维护包括基础服务和增值服务。基础服务第一年是免费赠送的，包括域名注册，主机空间和数据库，还有基本的技术支持，细节调整修改服务。增值服务包括第三方空间代购，网站内容发布管理，网站推广SEO等，费用我们会根据具体成本进行计价。</p>
					</div>
					<div class="clear"></div>
				</li>
				<li>
...
App/Tpl/duohuo/Home/images/answer_span.jpg">
					<div class="question_question_right">
						<p class="question_title">做一个网站大概需要多长时间？</p>
						<p class="question_answer">多火采用高效的项目管理流程，一般企业网站从设计到定稿到上线一般在20个工作日以内。</p>
					</div>
					<div class="clear"></div>
				</li>
				<li>
...
App/Tpl/duohuo/Home/images/answer_span.jpg">
					<div class="question_question_right">
						<p class="question_title">项目费用支付方式是什么，需要先支付吗？</p>
						<p class="question_answer">在我们没有确定方案和签署合同之前，您不需要支付任何费用。在项目开始之后，为了保证您的权利，我们坚持采用阶段性付款的形式。只有当项目完成之后您才支付我们最后的尾款。</p>
					</div>
					<div class="clear"></div>
				</li>
			</ul>
