<?php /* Smarty version Smarty-3.0.7, created on 2012-01-13 17:57:22
         compiled from "./App/Tpl/jiuqu/Dhadmin/Index_pageMain.html" */ ?>
<?php /*%%SmartyHeaderCode:317494f10000285e985-33998708%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_smarty_tpl->decodeProperties(array (
  'file_dependency' => 
  array (
    '38143f482405b0050cc335720be89e45df1541c5' => 
    array (
      0 => './App/Tpl/jiuqu/Dhadmin/Index_pageMain.html',
      1 => 1326364895,
      2 => 'file',
    ),
  ),
  'nocache_hash' => '317494f10000285e985-33998708',
  'function' => 
  array (
  ),
...
"));						
	...
	function editform(edit_id){			
		var edit_tab  = new Ext.FormPanel({
			...
			method:"post",
			height:500,
			reader: new Ext.data.JsonReader({successProperty: 'success',root: 'info'},['id','pid','aid','name','litpic','des','keywords','rank','content','tmp','url']), 
			border:false,
			items: {
				xtype:'tabpanel',
				activeTab: 0,
