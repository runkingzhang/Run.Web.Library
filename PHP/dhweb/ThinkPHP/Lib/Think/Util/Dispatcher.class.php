...
//$arr = preg_replace('@([a-z|A-Z|\d]+)_([^_]+)@e', '$var[\'\\1\']="\\2";','aid_1_pid_2');
//	print_r($var);
// die;
...
//                echo implode($depr,$paths)@([a-z|A-Z|\d]+)_([^_]+)@e
                // 解析剩余的URL参数
                $res = preg_replace('@([a-z|A-Z|\d]+)'.$depr.'([^_]+)@e', '$var[\'\\1\']="\\2";', implode($depr,$paths));
//                print_r($var);die;
