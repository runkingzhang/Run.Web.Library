...
KE.scriptPath = (function() {
	//alert(_SYSCFG_ROOT+"mtr/editor/");
	return _SYSCFG_ROOT+"mtr/editor/";
	if(KE.jsPath) return KE.jsPath;
...
KE.setting = {
	...
	items : [
		...
		'flash', 'media', 'advtable', 'hr', 'emoticons', 'link', 'unlink','accessory'
	],
	colorTable : [
...
KE.lang = {
	...
	invalidAccessory:'请输入正确的文件类型，仅允许：doc|xls|ppt|pdf|txt|rar|zip'
};
...
KE.plugin['accessory'] = {
  ...
  {
  case "doc":
   img= KE.scriptPath+"skins/common/attachmen.jpg";
  break;
  case "xls":
   img= KE.scriptPath+"skins/common/attachmen.jpg";
  break;
